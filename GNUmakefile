...
ROOTOBJS  := $(G4WORKDIR)/tmp/$(G4SYSTEM)/WCSim_ALC/WCSimRootEvent.o $(G4WORKDIR)/tmp/$(G4SYSTEM)/WCSim_ALC/WCSimRootGeom.o $(G4WORKDIR)/tmp/$(G4SYSTEM)/WCSim_ALC/WCSimPmtInfo.o $(G4WORKDIR)/tmp/$(G4SYSTEM)/WCSim_ALC/WCSimRootDict.o 
