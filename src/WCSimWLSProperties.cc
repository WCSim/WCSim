...
G4int Inr::GetNumEntries() { return nEntries_WLS_rindex;}
...
G4int Inr::GetNumEntries_ABS() { return nEntries_abslength_kuraray;}
...
G4int Inr::GetNumEntries_EM() { return nEntries_kuraray_component;}
