...
As of August 2014 WCSim has been moved to GitHub.  It can be found [here](https://github.com/WCSim/WCSim "https://github.com/WCSim/WCSim")  
...
   
 notifications [here](https://lists.phy.duke.edu/mailman/listinfo/wcsim-git "https://lists.phy.duke.edu/mailman/listinfo/wcsim-git")  
...
   
 The scripts it runs can be found in [this separate github repository](https://github.com/WCSim/Validation "https://github.com/WCSim/Validation")  
Validation results can be found [here](https://wcsim.github.io/Validation/ "https://wcsim.github.io/Validation/")  
**Documentation**  
*[!CAUTION]*  
 *  
...
   
 found [on the wiki](https://github.com/WCSim/WCSim/wiki "https://github.com/WCSim/WCSim/wiki")  
More detailed information about the simulation is available in  
   
 doc/DetectorDocumentation.pdf  
Additionally, doxygen documentation is available [here.  
   
 Note that most of the code has no doxygen comments, but all output class member variables are documented. See the WCSimRoot* classes](https://wcsim.github.io/WCSim/annotated.html "https://wcsim.github.io/WCSim/annotated.html")  
...
*[!TIP]*  
 *  
 If you just need to read WCSim output files, you can do this without the G4 dependency using the * *WCSim_WCSimRoot_only* * CMake option (see *[ *here* *).*](#anchor-1 "#anchor-1")  
...
   
 it easier to build many versions of the same software.](cmake.org "cmake.org")  
...
1. Install Docker cross platform instructions can be found at [https://www.docker.com/](https://www.docker.com/ "https://www.docker.com/")  
